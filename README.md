...
<h3>📌 1. 요구사항 분석</h3>
<ul>
  <li>주어진 댓글 리스트(CSV 파일)에서 대한민국 내 유효한 학교 이름을 추출하고, 이를 학교별로 등장 횟수를 집계하는 프로그램을 작성해야 합니다.</li>
  <li>댓글은 큰따옴표(")로 구분되며, 하나의 댓글에는 복수 개의 행정구역명, 학교명, 이모지, 특수문자 등이 혼재되어 있습니다.</li>
</ul>

<h3>📌 2. 전체 학교 정보를 가져올 API 선정</h3>
<ul>
  <li>공공데이터 기반의 학교 정보를 제공하는 API를 탐색하고 선정합니다.</li>
